...
/**
 * Spring Framework‚©‚çSeasar‚Ö‚ÌˆÚA”ÅŒü‚¯—áŠO‚Å‚·B
 * JDBC‚ÌXVˆ—‚ªŽž‚É—\Šú‚µ‚È‚¢”‚Ìs”‚É‰e‹¿‚ð‹y‚Ú‚µ‚½ê‡‚ÉƒXƒ[‚³‚ê‚Ü‚·B
 * “TŒ^“I‚È—á‚Æ‚µ‚Ä’Pˆê‚Ìs‚É‘Î‚µ‚Ä‚ÌXV‚É‘Î‚µ‚Ä•¡”—ñ‚É‰e‹¿‚ð‹y‚Ú‚µ‚½ê‡‚Ì
 * ƒGƒ‰[‚ðˆÓ–¡‚µ‚Ü‚·B
 * @author $Author:$
 * @version $Revision:$
 */
